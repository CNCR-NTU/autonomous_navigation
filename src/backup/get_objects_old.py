...
from autonomous_navigation.msg import ObjectsAtPosition
...
class get_objects:
    ...
    def __init__(self, outputTopic, laserTopic, PosTopic):
        ...
        self._positionNode = rospy.Publisher(
            outputTopic, ObjectsAtPosition, queue_size=1)
    ...
    def _publishData(self):
        ...
        msg = ObjectsAtPosition(std_msgs.msg.Header(stamp=rospy.Time.now())
