...
class laser_scanner:
    ...
    def __init__(self,lasTop,velTop,wDis,sDis,tol):
        ...
        self.__velocityNode = rospy.Publisher(velTop, geometry_msgs.msg.Twist,queue_size=1)
    ...
    def __get_scan(self):
        ...
        rospy.Subscriber(self.__laserTopic, sensor_msgs.msg.LaserScan, self.__callback)
        rospy.spin()
